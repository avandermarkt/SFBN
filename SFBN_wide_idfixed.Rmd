...
```{r}
newid <- SFBN_y100[,1]
SFBN_withid <- cbind (newid, SFBN_wide  )
```

```{r}
# added: re-assign variable names so msprep recognises them
names(SFBN_wide) <- c("id", "stage2", "stage2.s", "stage3.1", "stage31.s", "stage4", "stage4.s", "stage32", "stage32.s", "startstage")
...
sfbnlong <- msprep(time = c("stage2", "stage3.1", "stage4", "stage32"), status = c(  "stage2.s", "stage31.s", "stage4.s", "stage32.s"),  data = SFBN_wide, trans = tmat, id = "id", keep = covs) 
